...
class ERConcatDataset(ConcatDataset):
    ...
    def __getitem__(self, idx):
        ...
        # set real class id
        for per_instance in dataset_res['instances']:
            per_instance['bbox_label'] += self.class_id_start[dataset_idx]
        dataset_res['gt_bboxes_labels'] += self.class_id_start[dataset_idx]
        return dataset_res
